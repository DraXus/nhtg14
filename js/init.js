...
jQuery(window).load(function() {
	...
	/*********************************************************************************/
		...
		if (isLegacyIE || skel.isActive('desktop'))
		{
			...
			$("#results").text("Loading map...");
		    var latitude = 51.50722;
		    var longiture = -0.12750;
		    var limit = 1;
		    var defaultLatLng = new google.maps.LatLng(latitude, longiture);  // Default to London, UK when no geolocation support
